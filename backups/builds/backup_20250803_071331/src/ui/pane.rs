...
pub fn pane<'a>(state: &PaneState) -> Element<'a, PaneMessage> {
    ...
    WarpUI::glass_container(main_content.into())
        .width(Length::Fill)
        .height(Length::Fill)
        .into()
}
...
fn create_header<'a>(version: &str, is_maximized: bool) -> Element<'a, PaneMessage> {
    ...
    let settings_btn = WarpUI::secondary_button("⚙", Some(PaneMessage::SettingsPressed))
        .width(Length::Fixed(32.0))
        .height(Length::Fixed(24.0));

    let minimize_btn = WarpUI::secondary_button("−", Some(PaneMessage::MinimizePressed))
        .width(Length::Fixed(32.0))
        .height(Length::Fixed(24.0));

    let maximize_btn = WarpUI::secondary_button(
    ...
    let close_btn = WarpUI::secondary_button("×", Some(PaneMessage::ClosePressed))
        .width(Length::Fixed(32.0))
        .height(Length::Fixed(24.0));
...
fn create_input_area<'a>(input_value: &str) -> Element<'a, PaneMessage> {
    ...
    let clear_btn = WarpUI::secondary_button("Clear", Some(PaneMessage::ClearOutput))
